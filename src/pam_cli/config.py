...
# The Access dialog's Submit Request tab, which only requests access. Every
# tab has its own Hours and Reason fields, so searches stay inside this one.
REQUEST_TAB_NAME = "Submit Request"
REQUEST_SCOPE = "ps-request-access"
